...
import com.breitling.chesster.uci.option.ButtonEngineOption;
import com.breitling.chesster.uci.option.CheckEngineOption;
import com.breitling.chesster.uci.option.ComboEngineOption;
import com.breitling.chesster.uci.option.EngineOption;
import com.breitling.chesster.uci.option.SpinEngineOption;
import com.breitling.chesster.uci.option.StringEngineOption;
...
public class EngineOptionParser extends AbstractParser<EngineOption> 
{
    ...
    protected EngineOption doParse(String line, Matcher matcher) 
    {
        ...
        {
        case "button":
        	 return new ButtonEngineOption(optionName, defaultValue);
        	 
        case "check":
        	 return new CheckEngineOption(optionName, Boolean.parseBoolean(defaultValue));
        	 
        case "combo":
        	 return new ComboEngineOption(optionName, defaultValue);
        ...
        case "string":
        	 return new StringEngineOption(optionName, defaultValue);
        	 
        default: 
        	 throw new IllegalArgumentException("Invalid option type: " + line);
        }
    }
}